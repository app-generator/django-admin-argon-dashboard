...
Modern **[Django Dashboard](https://appseed.us/admin-dashboards/django/)** that covers `Admin Section`, all authentication pages (registration included) crafted on top of **Argon Dashboard**, an open-source `Bootstrap 5` design from `Creative-Tim`.
